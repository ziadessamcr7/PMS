...
import BlockModal from "../Users/BlockModal/BlockModal";
          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-md-4">
              <div className="profileImage text-center">
                {user.imagePath ? (
                  <img
                    src={`http://upskilling-egypt.com:3003/${user.imagePath}`}
...
<BlockModal show={show} id={id} handleClose={handleClose} getUserOrList={getUser} />
    </>
  );
}
