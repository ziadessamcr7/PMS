...
export default function Projects() {
  ...
  const getAllProjects = (pageNum: number) => {
    setLoading(true)
  ...
  return (
    ...
    <section className=''>
      ...
      <div className='d-flex justify-content-between bg-white rounded-2 p-3'>
        <h2>Projects</h2>
        <Link to={'/dashboard/add-project'} className='btn rounded-5 text-white d-flex align-items-center fw-bold'
          ...
          <table className="table table-striped">
            ...
            <thead >
              <tr >
                ...
                <th className='text-white' style={{ backgroundColor: '#315951E5' }} scope="col">username</th>
              ...
              {projectList?.map((proj: any, idx: any) => {
                return <tr key={idx}>
                  ...
                  <td>
                    ...
                    <Dropdown>
                      <Dropdown.Toggle style={{ backgroundColor: 'rgba(49, 89, 81, 0.90)' }} id="dropdown-basic">
                      </Dropdown.Toggle>
