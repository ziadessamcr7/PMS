...
export default function Users() {
  ...
  function getUserList({userName,groups,pageSize =5 ,pageNumber=1 }:any=[]) {
    setIsLoading(true);
    axios
      .get(`${url}Users/`,{
  ...
  return (
    <>
      ...
      <BlockModal show={show} id={id} handleClose={handleClose} getUserOrList={getUserList} />
      
      <div className="d-flex justify-content-center">
      <Paginate toltalNumberOfPages={toltalNumberOfPages} srchValue={srchValue} filterRole={filterRole} getList={getUserList}/>
